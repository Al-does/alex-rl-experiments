...
from experiments.strata_two_factor_explore_cycle_2.analysis import analyze_checkpoint
from experiments.strata_two_factor_explore_cycle_2.design import design_summary
...
def resolved_recipe(context: RunContext, condition: str) -> dict[str, Any]:
    return {
        **cycle_1.resolved_recipe(context, condition, REWARD_STATE),
        "study": "strata_two_factor_explore_cycle_2",
        "hypothesis": (
