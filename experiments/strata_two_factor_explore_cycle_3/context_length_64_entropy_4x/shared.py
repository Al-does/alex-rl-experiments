...
from experiments.strata_two_factor_explore_cycle_3.context_length_64_entropy_4x.analysis import (
    analyze_checkpoint,
)
...
MINIBATCH_SIZE = 512
ENTROPY_COEFF = 4 * cycle_1.ENTROPY_COEFF
...
MODEL_CONFIG = {
    **FactoredReproductionModelConfig(
    ...
    "sampling_temperature": cycle_1.SAMPLING_TEMPERATURE,
}
...
def resolved_recipe(context: RunContext, condition: str) -> dict[str, Any]:
    return {
        **cycle_1.resolved_recipe(context, condition, REWARD_STATE),
        ...
        "context_semantics": (
            "strict last 64 joint-token/previous-action frames including current; "
            "entropy coefficient 4x (0.012)"
        ),
    }
