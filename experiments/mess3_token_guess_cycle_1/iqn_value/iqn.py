...
class IQNTransformerModel(TransformerModel):
    """Transformer policy with an implicit-quantile value distribution."""
    ...
    def setup(self) -> None:
        ...
        # PPO's scalar value layer is replaced, not trained alongside IQN.
