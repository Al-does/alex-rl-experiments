...
from experiments.mess3_feedback_factoring_cycle_1.shared import CONDITIONS
...
def _run_one(
    *,
    ...
    if max_env_steps is not None:
        os.environ["MESS3_FEEDBACK_FACTORING_C1_MAX_ENV_STEPS"] = str(max_env_steps)
    print(
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            "Sequential multi-seed runner for one mess3_feedback_factoring_cycle_1 arm."
        )
    )
