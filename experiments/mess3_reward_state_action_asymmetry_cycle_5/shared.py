...
from experiments.mess3_reward_state_action_asymmetry_cycle_5.analysis import (
    ProbeResult,
    plot_probe,
    probe_checkpoint,
)
from experiments.mess3_reward_state_action_asymmetry_cycle_5.design import (
    ...
    return {
        "model": {
            ...
            "kwargs": {
                "alpha": 0.85,
                "transition_matrix": [
                    list(row) for row in CYCLE_5_TRANSITION_MATRIX
                ],
            },
        },
        "task": {
