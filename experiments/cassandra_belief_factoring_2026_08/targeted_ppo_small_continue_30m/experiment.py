"""Continue the stable small targeted policy for another 30M steps."""
...
SOURCE_RUN_ID = "20260820T193259Z-b0a45f73"
...
def build_config(context: RunContext) -> PPOConfig:
    """Build the 30M small targeted continuation recipe."""
