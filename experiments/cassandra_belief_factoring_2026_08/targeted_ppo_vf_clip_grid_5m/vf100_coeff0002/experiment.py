"""Train targeted PPO with vf_clip=100 and vf_loss_coeff=0.002."""
...
CONDITION = VfClipGridCondition(
    name="vf100_coeff0002",
    vf_clip_param=100,
    vf_loss_coeff=0.002,
    hypothesis=(
        "Widen value clipping to 10 with a scalar-matching gentle critic (beta~0.002)."
    ),
)
