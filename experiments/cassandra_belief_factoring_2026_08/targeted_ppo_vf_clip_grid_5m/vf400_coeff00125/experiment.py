"""Train targeted PPO with vf_clip=400 and vf_loss_coeff=0.0125."""
...
CONDITION = VfClipGridCondition(
    name="vf400_coeff00125",
    vf_clip_param=400,
    vf_loss_coeff=0.0125,
    hypothesis=(
        "Widen value clipping to 20 (sqrt(C)=20) while matching baseline maximum weighted value loss."
    ),
)
