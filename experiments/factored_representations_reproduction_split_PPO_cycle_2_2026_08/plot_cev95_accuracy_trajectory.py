...
DEFAULT_RUN_DIR = (
    ...
    / "ppo"
    / "results"
    / "20260831T060637Z-0e17f5f7"
)
DEFAULT_OUTPUT = DEFAULT_RUN_DIR / "cev95_accuracy_trajectory.png"
PANEL_SPECS = (
    ("Split PPO, 2 factors", "2_factors", 2),
    ("Split PPO, 3 factors", "3_factors", 3),
)
...
def plot_cev95_accuracy_trajectory(
    ...
    figure.suptitle(
        "Split actor PPO: activation dimensionality and task accuracy (seed 42)",
        fontsize=13,
    )
    figure.tight_layout()
