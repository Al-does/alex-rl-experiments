...
from experiments.mess3_belief_geometry_2026_07.paper_supervised_replication.mess3 import (
    AliasTable,
    bayesian_beliefs,
    enumerate_paths,
    labeled_operators,
...
from experiments.mess3_belief_geometry_2026_07.paper_supervised_replication.model import (
    PaperTransformer,
    parameter_count,
)
