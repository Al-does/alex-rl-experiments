...
from experiments.strata_token_guess_cycle_2 import analysis
from experiments.strata_token_guess_cycle_2.process import (
    CONTEXT_LENGTH,
    FACTOR_COUNT,
    STRATA_ALPHA,
    STRATA_T0,
...
from experiments.strata_token_guess_cycle_2.shared import (
    MODEL_CONFIG,
    SMOKE_BATCH_SIZE,
    SMOKE_ENV_STEPS,
...
from experiments.strata_token_guess_cycle_2.task import StrataTokenGuessTask
...
def test_delay_one_action_logits_guess_pending_single_strata_token():
    ...
    try:
        ...
        assert config["model"]["factory"] == "envs.strata.model:strata_model"
        ...
        assert isinstance(env.task, StrataTokenGuessTask)
...
def test_guesses_do_not_control_strata_dynamics():
    first = HMMEnv(
        {
            **environment_config(),
...
def test_model_emits_one_logit_per_strata_token():
